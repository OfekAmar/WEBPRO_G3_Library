...
import MyNotifyListPage from './MyNotifyListPage';
      ...
      <div className="flex items-center gap-4">
        {user ? (
          <>
            ...
            <button onClick={() => setPage('notifylist')} className="bg-pink-500 text-white px-3 py-2 rounded">Notify List</button>
            <button onClick={() => setPage('wishlist')} className="bg-pink-400 text-white px-3 py-2 rounded">Wishlist</button>
