...
function BookPage({ user }) {
  ...
  useEffect(() => {
    // Fetch book data and cover image from Firebase
  ...
  useEffect(() => {
    // Check if book is in user's notify list
  ...
  useEffect(() => {
    // Load average rating and comments for the book
  ...
  // Toggle book in user's notify list
  ...
  // Handle user rating and update book average rating
  ...
  // Handle borrowing a book: create borrow record, update available copies, show success popup
  ...
  // Handle returning a book: update borrow record, notify users, show late or success popup
