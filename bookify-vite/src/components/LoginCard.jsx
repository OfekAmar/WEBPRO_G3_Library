  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-full py-2 rounded mt-2 font-semibold text-cta-text transition 
          ${isFormValid ? 'bg-[rgba(var(--bookcard),1)] hover:bg-cta-active' : 'bg-[rgba(var(--border),1)] cursor-not-allowed'}`}
      >
        Login
      </button>
